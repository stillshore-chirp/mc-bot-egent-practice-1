...
既存環境の26.1系クライアント接続を検証するため、ComposeのPaper既定値を1.21.11に合わせ、ViaVersionを固定しました。構成と確認範囲は[26.1系クライアントの日本語チャット接続](docs/minecraft-26-1-chat.md)を参照してください。以下の1.21.1に関する記述は廃止時点の記録です。
